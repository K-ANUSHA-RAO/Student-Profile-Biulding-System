...
<center><h1>WELCOME</h1><table border="5" bgcolor="pink"> <h1 ><font color="blue"><b>STUDENT INFORMATION SYSTEM</b></font></h1><br>
<a href="home.php">HOME</a>&nbsp&nbsp&nbsp&nbsp<a href="update.php">UPDATE</a>&nbsp&nbsp&nbsp&nbsp<a href="delete.php">DELETE</a>&nbsp&nbsp&nbsp&nbsp<a href="search.php">SEARCH</a>&nbsp&nbsp&nbsp&nbsp<a href="markadd.php">MARK-ENTRY</a>&nbsp&nbsp&nbsp&nbsp<a href="markdisplay.php">MARK-DISPLAY</a><br><br></center>
	...
	<tr>
		<td>ROLL NO:</td>
		<td><input type="text" name="rn">Unique Id</td>
	</tr>
...
$q1=mysqli_query($conn,"insert into student values('$cap1','$cap2','$gen','$dd $mm $yy','$session','$rn','$branch','$year','$semester','$cap3')");
$q2=mysqli_query($conn,"insert into fees values('$rn','$cap1','$cap2','$fee')");
//$q3=mysqli_query($conn,"insert into iamarks('rn','fname','lname') values('$rn','$cap1','$cap2')");
